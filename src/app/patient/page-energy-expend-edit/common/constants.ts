import { IActivityFactor, IEnergyExpendProtocol, IInjuryFactor, IWomanSituation } from './types';
...
export const WomanSituation: IWomanSituation[] = [{ id: 1, description: 'Normal' }, { id: 2, description: 'Grávida' }, { id: 3, description: 'Lactante' }];